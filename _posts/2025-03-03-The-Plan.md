...
| **September – November**   | Algorithm Design Manual (Skiena) to understand "why" (chapters 3 4 5 6 7 8 + Appendix The Hitchhiker's Guide to Algorithms
), Coding interview patterns (Alex Xu) to train for "how", constantly hitting medium LeetCode, Codewars 4-3 kyu but prio will be LeetCode | ⭐⭐⭐⭐ (ADM) |
