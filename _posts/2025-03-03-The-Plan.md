...
| **September – December**    | Crafting Interpreters, AIMA, Deep Learning (Goodfellow), PRML (light)                                     | **Dots Refactor**, **LeetCode Hard**: 1/day continues                                                  | ⭐⭐⭐⭐ (AI), ⭐⭐⭐⭐⭐ (PRML), ⭐⭐⭐⭐ (Practice) |
| **Final Months (2027)**     | Software Engineering at Google, SICP final chapters (optional), **Efficient Python**                     | **Polishing**: GitHub, System Design Interviews, Final Dots Showcase, **LeetCode Hard** continues      | ⭐⭐⭐⭐⭐ (Final Readings), ⭐⭐⭐⭐⭐ (Practice) |
